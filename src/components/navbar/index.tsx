...
const Navbar: React.FC = () => {
    return (
        <nav className="fixed left-0 top-0 w-full h-[80px] bg-whit border-2 font-sans flex items-center justify-end bg-white">
            <div className="border-2 absolute -top-24 -left-48 -rotate-45 max-h-72 h-72 bg-primary aspect-[2/1]">Photografy</div>
